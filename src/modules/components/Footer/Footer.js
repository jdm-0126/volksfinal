          ...
          <Container fluid className="bg-info text-white px-2">
              <Row className="justify-content-center pt-2">
                ...
                <Col lg={2} md={6} sm={12} xs={12} className="my-5 h-50">
                  ...
                  <a className="d-block p-2" href="#about"> About Us</a>
                </Col>
                <Col lg={3} md={6} sm={12} xs={12} className="mt-5 h-50">
                  <h5 className="mb-4">Social</h5>
                  <a href='#'><i class="fa fa-facebook-official" aria-hidden="true"></i> Facebook</a> | <a href='#'><i class="fa fa-youtube" aria-hidden="true"></i> Youtube </a> | 
                  <a href='#'><i class="fa fa-twitter" aria-hidden="true"></i> Twitter </a> | <a href='#'><i class="fa fa-linkedin" aria-hidden="true"></i> Linkedin</a>
                </Col>
