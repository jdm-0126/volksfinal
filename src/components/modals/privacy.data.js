const PrivacyPolicy = [{
    id: 1,
    title: ``,
    content: `SaversAir Solutions is committed to ensuring that your privacy is protected. This Privacy Information sets out the basis on which any personal data we collect from you, or that you provide to us will be processed by us.
    `,
    content2: `SaversAir Solutions follows while processing your personal data the applicable Data Protection regulations. All data will be deleted if not needed for lawful processing any more.`
},

{
    ...
    content2:`1.1 SAVERSAIR SOLUTIONS INC. is committed to protecting and respecting your privacy.`,
    content3:`1.2 Your access to and use of this Website www.SaversAirSolutions.com and its contents (Website) is subject to the terms and conditions of this Privacy Policy (Privacy Policy), SaversAir Solutions's Terms of Trade posted on this Website (Terms of Trade), any documents referred to in the Terms of Trade or otherwise on this Website and all applicable laws.`,
...
},
{
    ...
    content2:`3.1.1 To provide you with SaversAir Solutions goods as ordered from the Website for business to business transactions.`,
    content3:`3.1.2 To provide you with information on SaversAir Solutions or its products or services which we feel may interest you. To optimize our services we may wish to use your personal data for direct marketing. As we respect your privacy we will only use your personal data for this purpose when you are aware thereof and if required we will request your consent prior to using your personal data for direct marketing.`,
...
},
{
    ...
    content: `4.1 We may disclose your personal information to any member of our group, including any related company of SaversAir Solutions insofar as reasonably necessary for the purposes set out in this policy.`,
    ...
    content4:`4.2.2 If SaversAir Solutions or substantially all of its assets are acquired by a third party, in which case personal information held by it about its customers will be one of the transferred assets.`,
    content5:`4.2.3 If we are under a duty to disclose or share your personal information in order to comply with any legal obligation, or in order to enforce or apply our Terms of Trade and other agreements, or to protect the rights, property or safety of SaversAir Solutions, our customers or others. This includes exchanging information with other companies and organizations for the purposes of fraud protection and credit risk reduction.`,
...
},
{
    ...
    content: `5.1 SaversAir Solutions controls and operates the Website from its location at SaversAir Solutions Corporate Address: Savers Mall Bldg., Mac Arthur Hi-way, Balibago, Angeles City, Philippines or from its registered address as may be informed to Securities and Exchange Commission of the Philippines (regardless of where hosting servers are located). You can contact us by telephone on +63 917 508 6647 or by email at info@SaversAirSolutions.com`,
    ...
    content3:`Thus, by accessing this website, you agree that SaversAir Solutions shall not be liable for any Damages arising out of or in connection with the use of, reliance on, or inability to use this Website or any of the materials or information contained therein. Moreover, you agree that SaversAir Solutions shall not be liable for any inaccuracies, incompleteness, errors or any defects in the materials or information and functions provided in this Website.`
},
{
    id: 8,
